...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"ArdoraActividades_resources/media/i1_marte.jpg","");
...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"ArdoraActividades_resources/media/i2_tierra.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv2").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"ArdoraActividades_resources/media/i3_mercurio.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv3").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"ArdoraActividades_resources/media/i4_venus.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv4").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"ArdoraActividades_resources/media/i5_jupiter.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv5").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"ArdoraActividades_resources/media/i6_saturno.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv6").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"ArdoraActividades_resources/media/i7_urano.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
$("#idDiv7").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"ArdoraActividades_resources/media/i8_Neptuno.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
}
